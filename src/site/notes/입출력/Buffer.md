---
{"dg-publish":true,"permalink":"/입출력/Buffer/","dgPassFrontmatter":true,"noteIcon":""}
---
...
자바에서는 데이터를 주고 받기 위해 [[입출력/Stream\|Stream]]을 쓴다.
키보드, 마우스 등 입력 장치로부터 출력 장치로 내보낼 때 버퍼 안에 저장된다.
#### 버퍼링
버퍼를 활용하는 방식 또는 버퍼를 채우는 동작
순서대로 입출력 되어야 하므로 [[자료구조/Queue\|Queue]]가 활용된다.
