---
{"dg-publish":true,"permalink":"/공부/자료구조/트리/최소 스패닝 트리(MST)/","dgPassFrontmatter":true,"dg-note-properties":{"permalink":"/공부/자료구조/트리/최소-스패닝-트리(mst)"}}
---


![mst.png](/img/user/%EC%B2%A8%EB%B6%80%ED%8C%8C%EC%9D%BC/mst.png)[[공부/자료구조/트리/신장트리\|신장트리]] 중에서 사용된 간선들의 가중치 합이 최소인 트리
