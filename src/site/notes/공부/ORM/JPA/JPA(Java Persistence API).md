---
{"dg-publish":true,"permalink":"/공부/ORM/JPA/JPA(Java Persistence API)/","dgPassFrontmatter":true,"dg-note-properties":{"permalink":"/공부/jpa/jpa(java-persistence-api)"}}
---


EJB 3.0에서 Hibernate를 기반으로 만든 자바 [[공부/ORM/ORM(Object Relational Mapping)\|ORM(Object Relational Mapping)]] 기술 표준
