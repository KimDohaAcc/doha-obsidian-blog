---
{"dg-publish":true,"permalink":"/공부/ORM/JPA/Annotation/@NoArgsConstructor/","dgPassFrontmatter":true,"dg-note-properties":{"permalink":"/공부/jpa/annotation/@noargsconstructor"}}
---
...
Entity의 Proxy 조회 때문
엔티티의 연관 관계에서 [[공부/ORM/JPA/지연 로딩(fetch = FetchType.LAZY)\|지연 로딩(fetch = FetchType.LAZY)]]의 경우에는 실제 엔티티가 아닌 **프록시 객체를 통해서 조회**를 한다
