---
{"dg-publish":true,"permalink":"/공부/알고리즘/벨만-포드 알고리즘(Bellman-Ford Algorithm)/","dgPassFrontmatter":true,"dg-note-properties":{"permalink":"/공부/알고리즘/벨만-포드-알고리즘(bellman-ford-algorithm)"}}
---
...
![belman_image.png](/img/user/%EC%B2%A8%EB%B6%80%ED%8C%8C%EC%9D%BC/belman_image.png)
...
##### 음수 간선 순환을 왜 확인할까?
![bellman_image.png](/img/user/%EC%B2%A8%EB%B6%80%ED%8C%8C%EC%9D%BC/bellman_image.png)
