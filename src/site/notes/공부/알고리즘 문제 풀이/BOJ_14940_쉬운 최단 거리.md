---
{"dg-publish":true,"permalink":"/공부/알고리즘 문제 풀이/BOJ_14940_쉬운 최단 거리/","dgPassFrontmatter":true,"dg-note-properties":{"permalink":"/공부/알고리즘-문제-풀이/boj_14940_쉬운-최단-거리"}}
---


전형적인 [[공부/알고리즘/다익스트라(Dijkstra) 알고리즘\|다익스트라(Dijkstra) 알고리즘]] 문제
조금 차이가 있다면 가중치가 1로 모두 같기 떄문에 [[공부/자료구조/Priority Queue\|Priority Queue]]를 쓸 필요가 없다
