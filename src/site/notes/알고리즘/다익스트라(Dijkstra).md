---
{"dg-publish":true,"permalink":"/알고리즘/다익스트라(Dijkstra)/","dgPassFrontmatter":true,"noteIcon":""}
---
...
3. **방문 배열을 생성**하여 방문했던 노드는 재방문하지 않게 한다.[[알고리즘/다익스트라(Dijkstra)#^visited\|#^visited]]
4. 출발 노드의 번호를 **변수([[자료구조/Priority Queue\|Priority Queue]])** 에 저장한다.
